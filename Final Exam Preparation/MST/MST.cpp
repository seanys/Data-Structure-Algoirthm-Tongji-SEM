...
int main()
{
	...
	edge * edge4 = new edge(10, nodeList[4], nodeList[5]);
	edgeList.push_back(edge4);
	edge * edge5 = new edge(2, nodeList[5], nodeList[6]);
	edgeList.push_back(edge5);
	edge * edge6 = new edge(1, nodeList[6], nodeList[7]);
